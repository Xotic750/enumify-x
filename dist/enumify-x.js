/*!
{
  ...
  "date": "2019-08-30T23:08:54.781Z",
  "describe": "",
  "description": "Enumerated type library.",
  "file": "enumify-x.js",
  "hash": "7ee1f94a3de756845095",
  "license": "MIT",
  "version": "2.1.2"
}
*/
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(13)(module), __webpack_require__(3)))
...
var enumify_x_esm_tempArray = [];
var enumify_x_esm_push = simple_methodize_x_esm(enumify_x_esm_tempArray.push);
var join = simple_methodize_x_esm(enumify_x_esm_tempArray.join);
var shift = simple_methodize_x_esm(enumify_x_esm_tempArray.shift);
/** @type {Set<string>} */
...
function Enum(name, value) {
  if (arguments.length > 0) {
    var strName = assertReserved(is_symbol_default()(name) === false && to_string_x_esm(name));
    object_define_properties_x_esm(this, {
      name: {
        enumerable: true,
        value: strName
...
var enumify_x_esm_initResults = function initResults() {
  return {
...
var enumify_x_esm_initialise = function initialise(obj) {
  var CstmCtr = obj.CstmCtr,
      properties = obj.properties,
      opts = obj.opts;
  var results = enumify_x_esm_initResults();
  ...
  var next;
  array_for_each_x_esm(items, function iteratee(item) {
    var ident;
...
var enumify_x_esm_calcString = function calcString(ctrName, names) {
  ...
  names.forEach(function iteratee(enumMember) {
    enumify_x_esm_push(strArr, Object(json3["stringify"])(enumMember.name));
  });
...
var enumify_x_esm_defineClassMethods = function defineClassMethods(constructionProps, opts) {
  if (is_object_like_x_esm(opts.classMethods)) {
    array_for_each_x_esm(object_keys_x_esm(opts.classMethods), function iteratee(key) {
      if (reserved.has(key)) {
...
var enumify_x_esm_defineInstanceMethods = function defineInstanceMethods(constructionProps, opts) {
  if (is_object_like_x_esm(opts.instanceMethods)) {
    array_for_each_x_esm(object_keys_x_esm(opts.instanceMethods), function iteratee(key) {
      if (reserved.has(key)) {
        throw new SyntaxError("Name is reserved: ".concat(key));
      }
    ...
    forEach: {
      value: function forEach(callback, thisArg) {
        constructionProps.data.keys.forEach(function iteratee(key) {
          simple_call_x_esm(callback, thisArg, [constructionProps.data.names.get(key)]);
        });
      }
    },
    toJSON: {
      value: function toJSON() {
        ...
        constructionProps.data.names.forEach(function iteratee(enumMember) {
          enumify_x_esm_push(value, enumMember.toJSON());
        });
        return value;
      }
    },
...
var enumify_x_esm_getConstruct = function getConstruct(constructionProps) {
  return function construct(context, args) {
    var argsArr = array_slice_x_esm(args);
    ...
    simple_call_x_esm(Enum, context, argsArr);
    return context;
  };
};

var enumify_x_esm_getConstructionProps = function getConstructionProps(typeName) {
  var props = {
    CstmCtr: null,
...
object_define_properties_x_esm(Enum, {
  ...
  create: {
    value: function create(typeName, properties, options) {
      var constructionProps = enumify_x_esm_getConstructionProps(typeName);
      /* eslint-disable-next-line no-new-func */
      ...
      constructionProps.data = enumify_x_esm_initialise({
